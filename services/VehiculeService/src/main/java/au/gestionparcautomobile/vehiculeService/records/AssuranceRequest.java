...
public record AssuranceRequest(
        ...
        double cout,
        @NotNull(message = "Détails de couverture sont requis")
        ...
        public AssuranceRequest withVehiculeId(Long vehiculeId) {
                return new AssuranceRequest(id, nomFournisseur, numeroPolice, dateDebutCouverture, dateFinCouverture, cout, detailsCouverture, vehiculeId, nomFichier, donneesFichier);
        }
}
